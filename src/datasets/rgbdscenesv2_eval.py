...
"""
RGBD-Scenes V2 File Formats: 
See https://rgbd-dataset.cs.washington.edu/dataset/rgbd-scenes-v2/;
"""
class MVSDataset(Dataset):
    def __init__(self, 
        ...
        self.test_seqs_list = [
            f"scene_{i:>02d}" for i in [1, 2, 5, 6, 9, 10, 13, 14]
            ]
...
- cd ~/PROJ_ROOT/
- python -m src.datasets.rgbdscenesv2_eval
"""
if __name__ == '__main__':
    ...
    from src.tools.utils import kitti_colormap, monodepth_colormap
    ...
    data_path = "/nfs/STG/SemanticDenseMapping/changjiang/data/rgbd-scenes-v2/exported_test"
    #data_path = "/home/ccj/datasets/rgbd-scenes-v2/exported_test"
    filename_txt_list = [
    ]
