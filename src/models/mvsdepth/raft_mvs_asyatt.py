...
from src.models.model_utils import updepth
...
"""
MVS + RAFT backbone  
+ apply asymetric attention to the convolution features of 
  reference image only, i.e., self-attention applied to feature f1,
  which is named as f1-attention for short;
...
class RAFT_MVS(RAFT_MVS_Base):
    def __init__(self, *args, **kwargs):
        ...
        self.model_card = "raft_mvs_f1_atten"
        if self.is_verbose:
    ...
    def run_raft_depth(self, current_image, lookup_images, 
        ...
        if self.adaptive_bins:
            ...
            #print (f"??? adaptive min_depth_bin={min_depth_bin}, max_depth_bin={max_depth_bin}") 
